        ...
        <div className="md:py-16 bg-white  ">
            <div className="container m-auto px-6 text-gray-600  xl:px-6">
                <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
                    <div className="hidden md:block md:5/12 lg:w-5/12">
                        <img
                            src={about}
                            alt="image"
                        />
                    ...
                    <div className="md:w-7/12 lg:w-6/12">
                        ...
                        <p className="my-6 text-gray-600">
                            Welcome to my <strong className="text-green-600">WordBox</strong> Text Analysis Tool! This page is designed to help you easily manipulate
